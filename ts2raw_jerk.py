...
try:
	...
	print("file exists")
print('sing_presto prepfold -ncpus 3 -npart 128 -n 128 -noxwin -accelcand %s -accelfile %s -dm %s -mask %s -o %s/raw_fold_%s %s' % (candnum, ACCELFILE, dm, MASK, OUTPUTFILE, ofile, obsfile))
